    ...
    class NewsListViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int position) {
            ...
            if (article.getUrlToImage() != null) {
                ...
                Glide.with(holderContext).load(article.getUrlToImage()).centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL).error(R.drawable.noimageavailable).into(newsCardImage);
            }
