 ...
 */
public class SettingsActivity extends AppCompatPreferenceActivity implements android.support.v7.widget.Toolbar.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupActionBar();
        getListView().setPadding(10, 100, 10, 10);
    }
    ...
    private void setupActionBar() {
        ...
        android.support.v7.widget.Toolbar t = findViewById(R.id.toolbarCustom);
...
//            bindPreferenceSummaryToValue(findPreference("example_list"));
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            if (view != null) {
                ...
                preferencesList.setPadding(10, 100, 10, 10);
            }
            return view;
        }
                ...
                public boolean onPreferenceChange(Preference preference, Object o) {
                    ...
                    if (on) {
                        Job job = dispatcher.newJobBuilder().
                                ...
                                .setRecurring(true)
                                .setTag(JOB_TAG)
                                .setTrigger(Trigger.executionWindow(0, 43200)) //TODO Set for 12 hours
